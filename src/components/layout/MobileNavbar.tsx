...
const MobileNavbar: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="fixed bottom-2 left-0 right-0 bg-white dark:bg-dark-700 shadow-lg border-t border-gray-200 dark:border-dark-600 h-20 px-4 flex items-center justify-between z-50 rounded-t-xl mx-2">
        <NavLink
          to="/"
          className={({ isActive }) => 
        ...
        >
          <div className="p-2 rounded-full touch-action-manipulation active:scale-95 transition-transform">
            ...
            <span className="text-xs mt-1 font-medium">Employees</span>
          </div>
        </NavLink>
        ...
        >
          <div className="bg-primary-600 rounded-full p-3 shadow-lg active:scale-95 transition-transform">
            <svg className="h-6 w-6 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
            </svg>
          </div>
          <span className="text-xs mt-1 font-bold">Add Shift</span>
        </button>
