...
const KeyboardShortcutsHelp: React.FC = () => {
  ...
  // Define keyboard shortcut groups
  const shortcuts = [
    {
      title: 'Navigation',
      items: [
        ...
        { key: 'Shift + ↑', description: 'Previous Day' },
        { key: 'Shift + ↓', description: 'Next Day' },
    ...
    },
    {
      title: 'Actions',
      items: [
        { key: 'Shift + N', description: 'New Shift' },
        { key: 'Shift + E', description: 'Edit Current Shift' },
        { key: 'Shift + P', description: 'Publish Schedule' },
        { key: 'Shift + I', description: 'Open Insights' },
        { key: 'Shift + T', description: 'Open Templates' },
    ...
    },
    {
      title: 'View Options',
      items: [
        { key: 'Shift + 1', description: 'Daily View' },
        { key: 'Shift + 2', description: 'Weekly View' },
        { key: 'Shift + 3', description: 'Staff View' },
        { key: 'Shift + 4', description: 'List View' },
        { key: 'Shift + 5', description: 'Grid View' },
      ],
    },
    {
      title: 'Accessibility',
      items: [
        { key: 'Shift + D', description: 'Toggle Dark Mode' },
        { key: 'Shift + C', description: 'Toggle High Contrast' },
        { key: 'Shift + F', description: 'Toggle Dyslexic Font' },
      ],
    },
  ];
